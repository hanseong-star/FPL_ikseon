...
```bash
git clone https://github.com/hanseong-star/FPL_ikseon.git
cd FPL_ikseon

2. Create a Virtual Environment
Option A: Conda (Recommended)
conda create -n fpl python=3.10 -y
conda activate fpl
...
pip install flask numpy pandas scikit-learn joblib pillow opencv-python
